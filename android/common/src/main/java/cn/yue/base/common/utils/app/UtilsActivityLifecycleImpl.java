...
public final class UtilsActivityLifecycleImpl implements Application.ActivityLifecycleCallbacks {
    ...
    public void addOnAppStatusChangedListener(final Utils.OnAppStatusChangedListener listener) {
        mStatusListeners.add(listener);
    }

    public void removeOnAppStatusChangedListener(final Utils.OnAppStatusChangedListener listener) {
