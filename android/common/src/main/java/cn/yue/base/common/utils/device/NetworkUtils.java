...
public class NetworkUtils {
    ...
    public static boolean isNetworkAvailable() {
        ConnectivityManager manager = (ConnectivityManager) Utils.getContext().getSystemService(
    ...
    public static boolean isMobile() {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.M) {
            NetworkCapabilities networkCapabilities =
                    mgrConn.getNetworkCapabilities(mgrConn.getActiveNetwork());
            if (networkCapabilities == null) return false;
            isNetUsable = networkCapabilities.hasTransport(NetworkCapabilities.TRANSPORT_CELLULAR);
        } else {
            isNetUsable = mgrConn.getActiveNetworkInfo() != null
                    && mgrConn.getActiveNetworkInfo().getType() == ConnectivityManager.TYPE_MOBILE;
        }
        return isNetUsable;
    }
}